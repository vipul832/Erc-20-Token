...
contract("VipToken", function (accounts) {
  var tokenInstance;

  it("initializes the contract with the correct values", function () {
    return VipToken.deployed()
      .then(function (instance) {
        tokenInstance = instance;
        return tokenInstance.name();
      })
      .then(function (name) {
        assert.equal(name, "Vip Token", "has the correct name");
      ...
      .then(function (standard) {
        assert.equal(standard, "Vip Token v1.0", "has the correct standard");
      });
  });
